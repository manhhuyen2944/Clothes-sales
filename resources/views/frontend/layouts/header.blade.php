        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="top-left">
                        <ul class="list-main">
                            <li><i class="ti-headphone-alt"></i> +84 986 359 385</li>
                            <li><i class="ti-email"></i> eshop@gmal.com</li>
                        </ul>
                    </div>
                    <!--/ End Top Left -->
                </div>
                                            ...
                                            @foreach(Helper::getAllProductFromCart() as $data)
                                                    ...
                                                    <li>
                                                        ...
                                                        <a class="cart-img" href="#">
                                                            <img src="{{asset('images/products')}}/{{$data->product['photo']}}" alt="#">
                                                        </a>
                                                        <h4><a href="{{route('product-detail',$data->product['id'])}}" target="_blank">{{$data->product['name']}}</a></h4>
